 ...
 */
final class Version20210601162210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD booker_id INT NOT NULL, ADD total INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP booker_id, DROP total');
    }
}
